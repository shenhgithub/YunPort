...
public class CheckUpdate {
    ...
    public void checkWithSpinner() {
        Log.i(LOG_TAG + "checkWithSpinner", "check update is invoked");
    ...
    public void checkNoPrompt() {
        Log.i(LOG_TAG + "checkNoPrompt", "check update is invoked");
    ...
    public void checkInBackground() {
        Log.i(LOG_TAG + "checkInBackground", "check update is invoked");
